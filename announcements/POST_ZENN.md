...
有料化の際は、プラットフォーム手数料 **6.6%** のみ。開発者が **93.4%** を受け取ります。
...
1. **X Publisher** — Xへの自動投稿 ([Issue #2](https://github.com/taihei-05/siglume-app-sdk/issues/2))
2. **Visual Publisher** — 画像生成+投稿 ([Issue #3](https://github.com/taihei-05/siglume-app-sdk/issues/3))
3. **MetaMask Connector** — ウォレット連携 ([Issue #4](https://github.com/taihei-05/siglume-app-sdk/issues/4))
