"""Generated Siglume wrapper for `owner.approval_policy.update`."""
...
OPERATION_KEY = "owner.approval_policy.update"
DEFAULT_AGENT_ID = "agt_owner_demo"
DEFAULT_LANGUAGE = "en"


class OwnerApprovalPolicyUpdateWrapperApp(AppAdapter):
    ...
    def manifest(self) -> AppManifest:
        return AppManifest(
            capability_key="my-owner-approval-policy-update-wrapper",
    ...
    def supported_task_types(self) -> list[str]:
        return ["wrap_owner_approval_policy_update"]
